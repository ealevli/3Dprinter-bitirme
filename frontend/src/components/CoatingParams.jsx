...
const PARAM_INFO = {
  ...
  z_offset: {
    ...
    step: 0.05,
    color: "purple",
    short: "Nozzle ile parça yüzeyi arasındaki mesafe",
    detail: [
      "Çok az (< 0.2 mm) → nozzle yüzeye sürtebilir, parça kayabilir",
      "0.3–0.5 mm → ideal: çözelti damlacık yapmadan yüzeye değer",
      "Çok fazla (> 1 mm) → çözelti akar, düzgün yayılmaz",
      "Bant kalınlığı bu değerin üstüne eklenir, parça tabladan yüksekse artır",
    ],
    presets: [
  ...
  band_thickness: {
    ...
    step: 0.1,
    color: "amber",
    short: "Parçanın altındaki çift taraflı bandın kalınlığı",
    detail: [
      "Parça tabladan ne kadar yüksekte? Bant kalınlığı Z başlangıcını ayarlar",
      "İnce bant (kargo bandı) ≈ 0.5–1 mm",
      "Kalın çift taraflı köpük bant ≈ 2–3 mm",
      "Doğru değer: nozzle kaplama sırasında parçaya hafifçe değmeli ama sürümemeli",
    ],
    presets: [
